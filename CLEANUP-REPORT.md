...
> **Note added 2026-07-27 on merge to `main`.** Only the removals and the three
> component fixes described below were merged. The Phase 0 rendered-HTML baseline
> referenced under "Verification" (`docs/qa/cleanup-baseline/`, ~55 000 lines of
> build output across 17 locales) was **deliberately not merged** — it is build
> evidence, not source. It remains on the `cleanup/performance-pass` branch, which
